// src/components/subtypes/GoatSubtypes.tsx - Lazy loaded goat subtypes component
import { Card, CardContent } from '@/components/ui/card';

// Import the goat subtypes data
import { goatSubtypes } from '@/data/goatSubtypes';

export default function GoatSubtypes({ selectedSubtype, onSelectSubtype }: { selectedSubtype: string | null; onSelectSubtype: (subtype: string) => void }) {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
      {goatSubtypes.map((option) => {
