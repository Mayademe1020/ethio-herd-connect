    ...
    return (
      <Card 
        className={`
          ...
          ${isDisabled 
            ...
            : 'hover:border-green-300 border-gray-200 hover:bg-gradient-to-br hover:from-green-50 hover:to-emerald-50'
          }
          touch-manipulation
          sm:min-h-[140px]
          lg:min-h-[160px]
      ...
      >
        ...
        <CardContent className="space-y-2">
          <div className={`text-2xl lg:text-3xl font-bold transition-colors duration-200 ${
          ...
          {stat.badge && !isDisabled && (
            <Badge className={`text-xs transition-colors duration-200 ${
              ...
              {stat.id === 'weekly-revenue' && <TrendingUp className="w-3 h-3 mr-1" />}
