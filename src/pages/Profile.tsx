...
import { User, Settings, Phone, MapPin, Calendar, Award, Farm, Edit } from 'lucide-react';
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-gradient-to-br from-green-600 to-emerald-700 rounded-full flex items-center justify-center">
                {farmProfile ? (
                  <Farm className="w-8 h-8 text-white" />
                ) : (
        ...
        {farmProfile ? (
          <Card className="border-green-100">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center space-x-3">
                <Farm className="w-5 h-5 text-gray-500" />
                <div>
          ...
          <Card className="border-yellow-200 bg-yellow-50">
            <CardContent className="p-6 text-center">
              <Farm className="w-12 h-12 mx-auto mb-3 text-yellow-600" />
