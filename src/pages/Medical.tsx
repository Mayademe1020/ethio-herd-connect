...
import { Stethoscope, Plus, Calendar, AlertTriangle, CheckCircle, Clock, Heart, Activity, Shield, Thermometer } from 'lucide-react';
...
const Medical = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-teal-50 pb-16 sm:pb-20 lg:pb-24">
      <EnhancedHeader />
      ...
      <main className="container mx-auto px-2 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6 space-y-3 sm:space-y-4 lg:space-y-6">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 text-left">
              {t.title}
            </h1>
          </div>
        ...
        <div className="flex justify-center">
          <Button onClick={() => setShowForm(!showForm)} className="bg-green-600 hover:bg-green-700 h-12 px-6 text-base text-left">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Input placeholder="COW001, GOAT002, etc." value={formData.animalId} onChange={e => setFormData({
                ...formData,
                ...
                <div>
                  ...
                  <Textarea placeholder={t.enterSymptoms} value={formData.symptoms} onChange={e => setFormData({
                ...formData,
                symptoms: e.target.value
              })} required rows={3} className="text-base" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input type="number" step="0.1" placeholder="38.5" value={formData.temperature} onChange={e => setFormData({
                  ...formData,
                ...
                <div>
                  ...
                  <Textarea placeholder={t.enterNotes} value={formData.notes} onChange={e => setFormData({
                ...formData,
                ...
                <div className="flex space-x-3">
                  <Button type="submit" className="flex-1 bg-green-600 hover:bg-green-700 h-12 text-base" disabled={loading}>
                    {loading ? <LoadingSpinner /> : t.save}
                  </Button>
                  <Button type="button" variant="outline" onClick={() => setShowForm(false)} className="flex-1 h-12 text-base">
                    {t.cancel}
                  </Button>
                </div>
              </form>
