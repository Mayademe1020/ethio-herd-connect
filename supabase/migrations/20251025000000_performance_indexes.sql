...
CREATE INDEX IF NOT EXISTS idx_milk_records_recorded_at ON milk_records(recorded_at DESC);
CREATE INDEX IF NOT EXISTS idx_milk_records_user_date ON milk_records(user_id, recorded_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_milk_records_animal_date ON milk_records(animal_id, recorded_at DESC);
...
COMMENT ON INDEX idx_milk_records_user_date IS 'Optimize queries for milk records by user and date';
